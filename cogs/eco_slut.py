...
class EcoSlut(commands.Cog):
    ...
    async def slut(self, ctx):
        ...
        if success:
            ...
            await ctx.send(f"💋 {ctx.author.mention}, aapne raste par ameer logon ko thoda entertain kiya aur **<a:money:852408387185672213> {earnings}** jhatak liye!")
        else:
            ...
            await ctx.send(f"📸 {ctx.author.mention}, aap saste kamo me pakde gaye! Police ne aap par **<a:money:852408387185672213> {fine}** ka fine thok diya! 💀")
