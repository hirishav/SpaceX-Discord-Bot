...
class OwnerStatus(commands.Cog):
    ...
    async def setstatus(self, ctx, status_type: str, activity_type: str = "playing", *, activity_name: str = None):
        ...
        await ctx.send(f"<a:giveaway:686211362548088858> Status badal kar **{status_type.upper()}** kar diya gaya hai!")
    ...
    async def updatetopgg(self, ctx):
        ...
        if success:
            embed = discord.Embed(
                title="<a:giveaway:686211362548088858> Top.gg Server Count Updated!",
