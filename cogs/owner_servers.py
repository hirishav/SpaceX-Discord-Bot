...
class OwnerServers(commands.Cog):
    ...
    async def add_premium(self, ctx, server_id: int):
        ...
        try:
            ...
            await ctx.send(f"<a:owner:1453608135104270498> Server `{server_id}` ko successfully **Premium** access de diya gaya hai!")
    ...
    async def remove_premium(self, ctx, server_id: int):
        ...
        try:
            ...
            await ctx.send(f"<a:owner:1453608135104270498> Server `{server_id}` ka **Premium** access remove kar diya gaya hai!")
        except Exception as e:
