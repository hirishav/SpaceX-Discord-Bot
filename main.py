    ...
    async def backup_db_task(self):
        ...
        try:
            ...
            if channel:
                ...
                print("-> <:verified_tick:837551087786393710> DB Backup successfully uploaded to Discord!")
        except Exception as e:
                                    ...
                                    if att["filename"] == "warnings.db":
                                        ...
                                        async with session.get(att["url"]) as file_resp:
                                            if file_resp.status == 200:
                                                ...
                                                print("-> <:verified_tick:837551087786393710> Successfully restored warnings.db from the cloud!")
                                                return
                    else:
